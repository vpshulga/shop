...
import com.gmail.vpshulgaa.service.impl.PermissionServiceImpl;
...
public class Test1 {
    public static void main(String[] args) {
        ...
        RoleDto role1 = roleService.findOne(1L);
        PermissionDto pFound4 = permissionService.findOne(4L);
        role1.getPermissions().add(pFound4);
